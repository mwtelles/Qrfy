    ...
    <form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text" id="url" name="url" class="form-control" value="" placeholder="<?= $this->language->menu->input->url_placeholder ?>" />
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control" value="" placeholder="<?= $this->language->menu->input->name_placeholder ?>" required="required" />
        </div>
