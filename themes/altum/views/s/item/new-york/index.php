    ...
    <nav aria-label="breadcrumb">
        <small>
            <ol class="custom-breadcrumbs">
                ...
                <li>
                    <a href="<?= $data->store->full_url . $data->menu->url . '/' . $data->category->url ?>"><?= $this->language->s_category->breadcrumb ?></a> <div class="svg-sm text-muted d-inline-block"><?= include_view(ASSETS_PATH . '/images/s/chevron-right.svg') ?></div>
                </li>
                <li class="active" aria-current="page"><?= $this->language->s_item->breadcrumb ?></li>
            </ol>
        </small>
    </nav>
